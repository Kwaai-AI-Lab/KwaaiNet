...
//!
//! `kwaai-cli::identity::NodeIdentity` keeps its own copy of this logic, with
//! its own path resolution / DID / credential-store concerns; the two are
//! compatible on disk.
