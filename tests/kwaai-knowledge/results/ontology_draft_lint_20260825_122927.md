# Arm C draft quality — 2026-08-25T19:29:27Z
...
| Legal | US Supreme Court Jurisprudence | 7 | 19 | 84% | 1 | 0 | 3 | 42% | **0.917** |
...
| PythonDocs | Python Library Reference | 8 | 14 | 100% | 7 | 0 | 7 | 14% | **0.75** |
...
- duplicate predicates: `is_bound_by_constitutional_provisions`
- 3 quote(s) justifying more than one predicate
...
- duplicate predicates: `HAS_ATTRIBUTE`, `IS_INSTANCE_OF`, `HAS_METHOD`, `IS_SUBCLASS_OF`, `HAS_CONSTANT`, `RAISES_EXCEPTION`, `IMPORTS_MODULE`
- 7 quote(s) justifying more than one predicate
