...
**CC quote:** `my brother Fazil`  ⚠️ no entity name in quote → EC skipped
...
**CC quote:** `one of Gandhi’s sons fell in love with one of Goulam Gool’s sisters`  ⚠️ no entity name in quote → EC skipped
...
**CC quote:** `the entire Abed family were originally from Durban and had apparently settled in the Cape ages ago without the required permission.`  ⚠️ no entity name in quote → EC skipped
