...
- Reuse `call_llm_for_relations()` (`rag_cmd.rs:7598`) verbatim for the HTTP call (it already has the working 120s hard-timeout wrapper for p2p-proxy hangs).
